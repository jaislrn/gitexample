...
public class BookRestController {
	...
	public ResponseEntity<Book> getBookById(@PathVariable("id") int id) {
		...
		header.add("token", "xxxxxxxxxxxxxx");
...
public class BookRestController {
	...
	//@RequestMapping(value="/rest/books", method = RequestMethod.POST)
	@PostMapping("/rest/books")
	public @ResponseBody Map<String, Object> insertBook(@RequestBody Book b) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
			bookService.addBook(b);
			map.put("Status", "OK");
	...
	@PutMapping("/rest/books/{id}")
	public @ResponseBody Map<String, Object> updatedBook(@PathVariable("id") int id, @RequestBody Book b) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
			bookService.updateBook(b);
			map.put("Status", "OK");
	...
	@DeleteMapping("/rest/books/{id}")
	public @ResponseBody Map<String, Object> deleteBook(@PathVariable("id") int id) {
		Map<String, Object> map = new HashMap<String, Object>();
		try {
			Book b = bookService.findBook(id);
			bookService.delBook(b);
